...
const PlaceOrder = ({ match,user,addToOrder }) => {
    ...
    return (
        <Fragment>
            <div className="card text-center PlaceOrder">
            <div className="card-header">
                Place Your Order
            </div>
            <div className="row justify-content-center mt-5" data-aos='fade-down'>
            <div className="card-group col-sm-3 mt-3" style={{"height": "15rem", "backgroundColor":"white"}}>
